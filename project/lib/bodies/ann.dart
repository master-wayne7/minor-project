...
class _AnnouncementState extends State<Announcement> {
  CollectionReference message = FirebaseFirestore.instance.collection('notification');
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: RawScrollbar(
        ...
        child: StreamBuilder(
          stream: FirebaseFirestore.instance.collection("notification").orderBy('createdOn', descending: true).snapshots(),
                ...
                : ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return Card(
                        ...
                        elevation: 10,
                        margin: const EdgeInsets.only(top: 10.0, left: 10, right: 15, bottom: 3),
                        child: Padding(
                          padding: const EdgeInsets.only(left: 9, right: 8, top: 15, bottom: 7),
                          child: Column(
                            ...
                            children: [
                              ...
                              snapshot.data!.docs[index]['link'] == ''
                                  ...
                                  : TextButton(
                                      onPressed: (() {
                                        openFile(url: snapshot.data!.docs[index]['link'], fileName: snapshot.data!.docs[index]['message']);
                                      }),
