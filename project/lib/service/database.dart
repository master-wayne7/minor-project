...
class DatabaseServices {
  ...
  final ref = FirebaseDatabase(databaseURL: "https://locate-it-e063c-default-rtdb.asia-southeast1.firebasedatabase.app/")
      // ignore: deprecated_member_use
      .ref("BUS");

  fatchDatabase() async {
    BitmapDescriptor markerIcon = await Get.find<MapController>().updateCustomIcon();
