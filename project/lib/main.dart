...
import 'package:locate_it_user_1/firebase_options.dart';
  ...
  SystemChrome.setPreferredOrientations([
    ...
    runApp(
      MaterialApp(
        ...
        theme: ThemeData(primaryColor: const Color.fromARGB(255, 158, 239, 255), useMaterial3: false),
      ),
    );
    SystemChrome.setPreferredOrientations([
      DeviceOrientation.portraitUp,
      ...
      () async {
        Timer(
          ...
          () => Navigator.of(context).pushReplacement(
            MaterialPageRoute(
              builder: (context) => finalEmail == null ? const HomePage() : const MainScreen(),
            ),
          ),
        );
      },
