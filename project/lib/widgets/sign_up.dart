...
class _SignUpState extends State<SignUp> {
  ...
  Future<void> sendOTP() async {
    emailOTP.setConfig(appEmail: "synergypnrrvv@gmail.com", appName: "Locate It", userEmail: _emailController.text, otpLength: 6, otpType: OTPType.digitsOnly);
        ...
        children: [
                ...
                decoration: InputDecoration(
                  suffixIcon: _passwordController.text.isEmpty
                      ...
                      : IconButton(
                          ...
                          icon: Icon(obscure == true ? Icons.remove_red_eye_rounded : Icons.remove_red_eye_outlined, color: Colors.grey)),
          ...
          Padding(
            ...
            child: RawMaterialButton(
              ...
              onPressed: () async {
                verifyOTP();
                if (_emailKey.currentState!.validate() && _passwordKey.currentState!.validate() && _nameKey.currentState!.validate() && _otpKey.currentState!.validate() && verified == 1) {
  ...
  void signUp(String email, String password) async {
    if (_emailKey.currentState!.validate() && _passwordKey.currentState!.validate() && _nameKey.currentState!.validate()) {
      await _auth
