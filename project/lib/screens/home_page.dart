    ...
    return Container(
      decoration: const BoxDecoration(
        gradient: LinearGradient(
          ...
          colors: [
            Color.fromARGB(255, 158, 239, 255),
            Colors.white
          ],
        ),
      ),
          ...
          child: Padding(
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  Container(margin: EdgeInsets.only(bottom: 10, left: screenSize().width * 0.05), height: screenSize().height * 0.13, child: const Image(image: AssetImage('assets/icon.png'))),
                  SizedBox(
                              ...
                              children: [
                                SizedBox(
                                  ...
                                  child: RawMaterialButton(
                                    ...
                                    fillColor: hasBeenPressed1 == 1 ? Colors.white : const Color.fromARGB(255, 217, 217, 217),
                                    enableFeedback: true,
                                    shape: const RoundedRectangleBorder(borderRadius: BorderRadius.only(topLeft: Radius.circular(25))),
                                    onPressed: (() {
                                      setState(() {
                                        _currentIndex = 0;
                                        hasBeenPressed1 = 1;
                                ...
                                SizedBox(
                                  ...
                                  child: RawMaterialButton(
                                    elevation: 0,
                                    focusColor: Colors.white,
                                    fillColor: hasBeenPressed2 == 1 ? Colors.white : const Color.fromARGB(255, 217, 217, 217),
