                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    const Text('''Submit your email address here to reset your password. Follow the link provided in the mail and create a new password for your account. Don't forget to check the spam folder.'''),
                                    const SizedBox(
                                      height: 20.0,
                                    ),
                                    Card(
